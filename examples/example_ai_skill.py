...
class AISkillTaskSet(AppianTaskSet):
    ...
    def create_new_AI_Skill(self):
        ...
        invoice_files = ["/path/Invoice 1.pdf", "/path/Invoice 2.pdf", "/path/Invoice 3.pdf", "/path/Invoice 4.pdf", "/path/Invoice 5.pdf", "/path/Invoice 6.pdf", "/path/Invoice 7.pdf", "/path/Invoice 8.pdf", "/path/Invoice 9.pdf", "/path/Invoice 10.pdf"]
        ...
        purchase_order_files = ["/path/PurchaseOrder 1.pdf", "/path/PurchaseOrder 2.pdf", "/path/PurchaseOrder 3.pdf", "/path/PurchaseOrder 4.pdf", "/path/PurchaseOrder 5.pdf", "/path/PurchaseOrder 6.pdf", "/path/PurchaseOrder 7.pdf", "/path/PurchaseOrder 8.pdf", "/path/PurchaseOrder 9.pdf", "/path/PurchaseOrder 10.pdf"]
